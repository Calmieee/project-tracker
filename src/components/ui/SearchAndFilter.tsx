        ...
        <Popover className="relative">
          {({ open }) => (
            <div className="absolute left-5">
              <Popover.Button className="inline-flex items-center gap-x-1.5 rounded-md bg-[#1a1a1e] px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-700 hover:bg-gray-800">
                <Funnel />
                Фильтр
