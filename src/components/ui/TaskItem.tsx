...
const TaskItem = ({ task } : {task: TIssues}) => (
  <li
    className={clsx(
      'w-full bg-[#1a1a1e]/80 p-4 rounded-md',
      'border-l-4 flex flex-col gap-2',
      'transition-shadow transition-colors duration-200 ease-in-out hover:cursor-pointer',
    ...
    <div className="flex justify-between items-center">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link
          ...
          className="text-xs p-3 bg-blue-900 hover:bg-blue-800 text-white rounded-md transition-colors"
        >
          Перейти к доске
        </Link>
      </div>
